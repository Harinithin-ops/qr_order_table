...
import { QrCode, Download, ExternalLink, Activity } from 'lucide-react';
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl mx-auto">
      <div className="mb-8 border-b border-gray-200 pb-6 flex justify-between items-end">
        <div>
           <Link href="/dashboard" className="text-gray-500 font-medium text-sm hover:underline mb-2 inline-block">&larr; Back to Dashboard</Link>
