        ...
        <div className="p-8">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gray-900 text-white font-bold py-3 px-4 rounded-lg hover:bg-black transition-colors focus:outline-none disabled:opacity-70"
            >
              {loading ? 'Authenticating...' : 'Login'}
            </button>
            <div className="text-xs text-gray-500 text-center mt-4">
              MVP default: admin / kavitha2024
            </div>
          </form>
        </div>
      </div>
