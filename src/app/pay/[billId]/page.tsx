...
export default function CustomerPayPage({ params }: { params: Promise<{ billId: string }> }) {
    ...
    <div className="min-h-screen bg-gray-50 pb-20 max-w-md mx-auto shadow-xl">
      ...
      <div className="p-4 space-y-6">
        ...
        {!isPaid && !isAwaiting && paymentMethod === 'UPI' && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 text-center fade-in">
            ...
            <div className="border-t border-gray-100 pt-5">
              ...
              >
                ...
                <button 
                  type="submit" 
                  disabled={submitting}
                  className="w-full bg-gray-900 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 disabled:opacity-50"
                >
        ...
        {isAwaiting && (
          <div className={`${bill.paymentMethod === 'CASH' ? 'bg-emerald-50 border-emerald-200' : 'bg-yellow-50 border-yellow-200'} rounded-2xl border p-6 text-center shadow-sm`}>
